...
const App = () => {
console.log('render')
  const [searchField, setSearchField] = useState('XXX'); //[value setSvalue]
 const [ monsters,setMonsters]=useEffect('')
  ...
  // if I put fetch here, will render forever

  return (
    <div className='App'>
      <h1 className='app-title'>Monsters Yoyoy</h1>
      <SearchBox
